...
> = {
  ...
  VERSION_NOT_FOUND: {
    ...
    description:
      'One or both of the selected versions could not be found.',
    guidance:
      'The version may have been deleted. Please select different versions to compare.',
    icon: '🔍',
    canRetry: false,
  },
  INCOMPATIBLE_SCHEMA: {
  ...
  NETWORK_ERROR: {
    title: 'Network Error',
    description:
      'Unable to fetch version data due to a network issue.',
    guidance:
